...
static VALUE libvirt_domain_block_stats(VALUE d, VALUE path)
{
    ...
    r = virDomainBlockStats(ruby_libvirt_domain_get(d), StringValueCStr(path),
                            &stats, sizeof(stats));
    _E(r < 0, ruby_libvirt_create_error(e_RetrieveError, "virDomainBlockStats",
                                        ruby_libvirt_connect_get(d)));
...
static VALUE libvirt_domain_memory_stats(int argc, VALUE *argv, VALUE d)
{
    ...
    r = virDomainMemoryStats(ruby_libvirt_domain_get(d), stats, 6,
                             NUM2UINT(flags));
    _E(r < 0, ruby_libvirt_create_error(e_RetrieveError, "virDomainMemoryStats",
                                        ruby_libvirt_connect_get(d)));
...
static VALUE libvirt_domain_block_peek(int argc, VALUE *argv, VALUE d)
{
    ...
    r = virDomainBlockPeek(ruby_libvirt_domain_get(d), StringValueCStr(path),
                           ...
                           NUM2UINT(flags));
    _E(r < 0, ruby_libvirt_create_error(e_RetrieveError, "virDomainBlockPeek",
                                        ruby_libvirt_connect_get(d)));
...
static VALUE libvirt_domain_memory_peek(int argc, VALUE *argv, VALUE d)
{
    ...
    flags = ruby_libvirt_fixnum_set(flags, VIR_MEMORY_VIRTUAL);

    buffer = alloca(sizeof(char) * NUM2UINT(size));

    r = virDomainMemoryPeek(ruby_libvirt_domain_get(d), NUM2ULL(start),
                            NUM2UINT(size), buffer, NUM2UINT(flags));
    _E(r < 0, ruby_libvirt_create_error(e_RetrieveError, "virDomainMemoryPeek",
                                        ruby_libvirt_connect_get(d)));
 ...
 */
static VALUE libvirt_domain_get_vcpus(VALUE d)
{
...
static VALUE libvirt_domain_id(VALUE d)
{
     ...
     */
    out = id;
    _E(out == -1, ruby_libvirt_create_error(e_RetrieveError, "virDomainGetID",
                                            ruby_libvirt_connect_get(d)));
...
static VALUE libvirt_domain_max_memory(VALUE d)
{
    ...
    _E(max_memory == 0, ruby_libvirt_create_error(e_RetrieveError,
 ...
 * allowed to access.
 */
static VALUE libvirt_domain_max_memory_set(VALUE d, VALUE max_memory)
{
    int r;

    r = virDomainSetMaxMemory(ruby_libvirt_domain_get(d),
                              NUM2ULONG(max_memory));
    _E(r < 0, ruby_libvirt_create_error(e_DefinitionError,
 ...
 */
static VALUE libvirt_domain_memory_set(VALUE d, VALUE in)
{
    VALUE memory;
    VALUE flags;
    int r;
    ...
    _E(r < 0, ruby_libvirt_create_error(e_DefinitionError, "virDomainSetMemory",
                                        ruby_libvirt_connect_get(d)));
 ...
 */
static VALUE libvirt_domain_vcpus_set(VALUE d, VALUE in)
{
    VALUE nvcpus;
    VALUE flags;
 ...
 */
static VALUE libvirt_domain_vcpus_set_flags(VALUE d, VALUE in)
{
    VALUE nvcpus;
    VALUE flags;
...
static VALUE libvirt_domain_autostart(VALUE d)
{
    ...
    _E(r < 0, ruby_libvirt_create_error(e_RetrieveError, "virDomainAutostart",
                                        ruby_libvirt_connect_get(d)));
 ...
 */
static VALUE libvirt_domain_autostart_set(VALUE d, VALUE autostart)
{
...
static VALUE libvirt_domain_snapshot_create_xml(int argc, VALUE *argv, VALUE d)
{
    ...
    ret = virDomainSnapshotCreateXML(ruby_libvirt_domain_get(d),
                                     StringValueCStr(xmlDesc), NUM2UINT(flags));

    _E(ret == NULL, ruby_libvirt_create_error(e_Error,
                                                    ...
                                                    VALUE d)
{
    ...
    snap = virDomainSnapshotLookupByName(ruby_libvirt_domain_get(d),
                                         ...
                                         NUM2UINT(flags));
    _E(snap == NULL, ruby_libvirt_create_error(e_RetrieveError,
...
static VALUE libvirt_domain_job_info(VALUE d)
{
    ...
    _E(r < 0, ruby_libvirt_create_error(e_RetrieveError, "virDomainGetJobInfo",
                                        ruby_libvirt_connect_get(d)));
...
static VALUE libvirt_domain_scheduler_type(VALUE d)
{
    ...
    _E(type == NULL, ruby_libvirt_create_error(e_RetrieveError,
...
static VALUE libvirt_domain_qemu_monitor_command(int argc, VALUE *argv, VALUE d)
{
    ...
    _E(type == NULL, ruby_libvirt_create_error(e_Error, "virConnectGetType",
                                               ruby_libvirt_connect_get(d)));
 ...
 */
static VALUE libvirt_domain_get_scheduler_parameters(int argc, VALUE *argv,
                                                     VALUE d)
{
...
static int memory_nparams(VALUE d, unsigned int flags)
{
    ...
    ret = virDomainGetMemoryParameters(ruby_libvirt_domain_get(d), NULL,
                                       &nparams, flags);
...
static int blkio_nparams(VALUE d, unsigned int flags)
{
    ...
    ret = virDomainGetBlkioParameters(ruby_libvirt_domain_get(d), NULL,
                                      &nparams, flags);
    _E(ret < 0, ruby_libvirt_create_error(e_RetrieveError,
...
static VALUE libvirt_domain_get_state(int argc, VALUE *argv, VALUE d)
{
    ...
    retval = virDomainGetState(ruby_libvirt_domain_get(d), &state, &reason,
                               NUM2INT(flags));
    _E(retval < 0, ruby_libvirt_create_error(e_Error, "virDomainGetState",
                                             ruby_libvirt_connect_get(d)));
 ...
 */
static VALUE libvirt_domain_set_metadata(VALUE d, VALUE in)
{
...
static VALUE libvirt_domain_send_process_signal(int argc, VALUE *argv, VALUE d)
{
    ...
    ruby_libvirt_generate_call_nil(virDomainSendProcessSignal,
                                   ...
                                   NUM2UINT(signum), NUM2UINT(flags));
}
#endif
...
void ruby_libvirt_domain_init(void)
{
    ...
    rb_define_method(c_domain, "max_memory=", libvirt_domain_max_memory_set, 1);
    rb_define_method(c_domain, "memory=", libvirt_domain_memory_set, 1);
    rb_define_method(c_domain, "max_vcpus", libvirt_domain_max_vcpus, 0);
    rb_define_method(c_domain, "vcpus=", libvirt_domain_vcpus_set, 1);
#if HAVE_VIRDOMAINSETVCPUSFLAGS
    rb_define_method(c_domain, "vcpus_flags=", libvirt_domain_vcpus_set_flags,
                     1);
#endif
    ...
    rb_define_method(c_domain, "autostart?", libvirt_domain_autostart, 0);
    rb_define_method(c_domain, "autostart=", libvirt_domain_autostart_set, 1);
...
#endif
    rb_define_method(c_domain, "get_vcpus", libvirt_domain_get_vcpus, 0);
#if HAVE_VIRDOMAINISACTIVE
    ...
    rb_define_method(c_domain, "state", libvirt_domain_get_state, -1);
#endif
